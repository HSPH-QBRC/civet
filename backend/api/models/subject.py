...
class Subject(models.Model):
    ...
    bmi_cm_v1 = models.DecimalField(
        null=True, default=None, max_digits=4, decimal_places=2)
    bmi_cm_v2 = models.DecimalField(
        null=True, default=None, max_digits=4, decimal_places=2)
    cbc_eosinophil_pct_v1 = models.DecimalField(
        null=True, default=None, max_digits=4, decimal_places=2)
    cbc_lymphocyte_pct_v1 = models.DecimalField(
        null=True, default=None, max_digits=4, decimal_places=2)
    cbc_neutrophil_pct_v1 = models.DecimalField(
        null=True, default=None, max_digits=4, decimal_places=2)
    facit_socialwellbeing_v1 = models.DecimalField(
        null=True, default=None, max_digits=3, decimal_places=1)
    wt_kg_v1 = models.DecimalField(
        null=True, default=None, max_digits=5, decimal_places=2)

    # continuous + char (whatever that means...)
    advair_puffsday_v1 = models.DecimalField(
        null=True, default=None, max_digits=5, decimal_places=2)
    albuterol_puffsday_v1 = models.DecimalField(
        null=True, default=None, max_digits=5, decimal_places=2)
